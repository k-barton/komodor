...
(function () {
	...
	this.startR = function () {
		...
		if(isWin && id == "r-terminal") {
            ...
            RProcessObserver = this.runSystemCommand(cmd, rDir, env, _RterminationCallback);
...
this.onLoad = function(event) {
	setTimeout(function() {
		...
		if(cuih) {
			...
			cuih.prototype.types.argument = "chrome://komodor/skin/images/cb_argument.png";
			cuih.prototype.types.grapharg = "chrome://komodor/skin/images/cb_graphical_argument.png";
			cuih.prototype.types.dataset = "chrome://komodor/skin/images/cb_data.png";
		} else { // Komodo 6
			//// How to register the images for each document? Does it still make sense?
			//// currently some items will be shown without images.
